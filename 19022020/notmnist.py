...
def load_notmnist(path='./notMNIST_small', letters='ABCDEFGHIJ', img_shape=(28, 28), test_size=0.25, one_hot=False):
    ...
    for img_path in glob(os.path.join(path, '*/*')):
        ...
        try:
            ...
            print(
                "found broken img: %s [it's ok if <10 images are broken]" % img_path)
